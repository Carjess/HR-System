<x-app-layout>
    <x-slot name="header">
        ...
        <style>
            ...
            /* AÑADIDO: cursor: pointer para indicar que toda la fila es un enlace */
                        ...
                        <form method="GET" action="{{ route('departamentos.index') }}" class="sm:flex sm:items-center gap-4 w-full sm:w-auto">
                            <div class="relative">
                                <input placeholder="Buscar departamento..." 
                                       class="input shadow-sm hover:shadow-md focus:shadow-lg focus:border-2 border-gray-300 px-5 py-3 rounded-xl w-56 transition-all focus:w-64 outline-none dark:bg-gray-800 dark:border-gray-700 dark:text-white dark:placeholder-gray-400 font-medium" 
                                       name="search" 
                                       type="search" 
                            ...
                            <button type="submit" class="btn-anim w-full sm:w-auto text-white bg-blue-600 hover:bg-blue-700 focus:ring-4 focus:ring-blue-300 font-semibold rounded-xl text-base px-8 py-3 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800 shadow-md">Buscar</button>
                        </form>
                    ...
                    <div class="overflow-hidden rounded-2xl shadow-md border border-gray-200 dark:border-gray-700"> 
                        <table class="w-full text-left text-gray-500 dark:text-gray-400">
                            <thead class="text-sm text-gray-700 uppercase font-bold tracking-wider bg-gray-100 dark:bg-gray-700/50">
                                <tr>
                                    <th scope="col" class="px-6 py-4">Nombre del Departamento</th>
                            ...
                            <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                                @forelse ($departments as $department)
                                    <!-- 
                                        CAMBIO: onclick en el TR para ir a Administrar Departamento.
                                        Esto hace que toda la fila sea un botón gigante.
                                    -->
                                    <tr class="bg-white dark:bg-gray-800 row-card transition-colors"
                                        ...
                                        <!-- Nombre -->
                                        <td class="px-6 py-5 whitespace-nowrap text-lg font-bold text-gray-900 dark:text-white">
                                            {{ $department->name }}
                                        </td>

                                        <!-- Fecha Creación -->
                                        <td class="px-6 py-5 hidden sm:table-cell text-base text-gray-600 dark:text-gray-300">
                                        ...
                                        <td class="px-6 py-5 text-right">
                                            <div class="flex items-center justify-end gap-3">
                                                <!-- Editar / Gestionar (Con stopPropagation) -->
                                                <a href="{{ route('departamentos.edit', $department->id) }}" 
                                                   onclick="event.stopPropagation()"
                                                   class="text-gray-400 hover:text-blue-600 dark:text-gray-500 dark:hover:text-blue-400 p-2 rounded-full hover:bg-blue-50 dark:hover:bg-gray-700 transition-all" 
                                                   title="Gestionar Cargos y Editar">
                                                    <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"></path></svg>
                                                </a>
                                                
                                                <!-- Eliminar (Con stopPropagation) -->
            ...
            <div class="relative w-full max-w-md h-auto" @click.away="showCreateModal = false">
                <div class="relative bg-white rounded-xl shadow-2xl dark:bg-gray-800 border border-gray-200 dark:border-gray-700">
                    ...
                    <div class="flex justify-between p-5 border-b rounded-t dark:border-gray-600 bg-gray-50 dark:bg-gray-900/50">
                        ...
                        <button @click="showCreateModal = false" class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center dark:hover:bg-gray-600 dark:hover:text-white">
                    ...
                    <form method="POST" action="{{ route('departamentos.store') }}" class="p-8">
                        ...
                        <div class="mb-6">
                            <label for="name" class="block mb-2 text-base font-medium text-gray-900 dark:text-white">Nombre del Departamento</label>
                            <input type="text" name="name" id="name" 
                                   class="bg-gray-50 border border-gray-300 text-gray-900 text-base rounded-xl focus:ring-blue-500 focus:border-blue-500 block w-full p-3 dark:bg-gray-700 dark:border-gray-600 dark:text-white shadow-sm" 
                                   value="{{ old('name') }}" required autofocus placeholder="Ej. Marketing, Finanzas...">
                            @error('name')
                        ...
                        <div class="flex justify-end space-x-3">
                            <button @click="showCreateModal = false" type="button" class="text-gray-700 bg-white border border-gray-300 hover:bg-gray-50 focus:ring-4 focus:outline-none focus:ring-blue-300 font-semibold rounded-xl text-base px-6 py-2.5 dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 dark:hover:bg-gray-700 transition-colors">
                                Cancelar
                            </button>
                            <button type="submit" class="text-white bg-blue-600 hover:bg-blue-700 focus:ring-4 focus:outline-none focus:ring-blue-300 font-semibold rounded-xl text-base px-6 py-2.5 dark:bg-blue-600 dark:hover:bg-blue-700 transition-colors">
                                Guardar
                            </button>
                        </div>
                    </form>
